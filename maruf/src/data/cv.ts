...
export const cvData = {
  personal: {
    ...
    image: "/images/profile/hero-shot.jpg", 
    ...
    skills: ["Microsoft Word", "Excel", "PowerPoint", "Translation & Transcription", "Qualitative & Quantitative Research", "Media Research", "Fact Checking", "Field Monitoring", "Literature Review", "Report & Proposal Writing", "Data Visualization"]
  },
  workExperience: [
    {
